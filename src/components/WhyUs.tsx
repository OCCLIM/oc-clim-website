...
export default function WhyUs() {
  return (
    <section id="pourquoi-nous" className="py-24 sm:py-32 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {reasons.map((r) => {
            ...
            return (
              <div
                key={r.title}
                className="group bg-white rounded-2xl p-7 border border-[#E2E8F0] hover:border-[#0369A1]/20 hover:shadow-md transition-all duration-300"
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="h-10 w-10 rounded-lg bg-[#0369A1]/10 flex items-center justify-center group-hover:bg-[#0369A1] transition-colors duration-300">
                    <Icon className="h-4.5 w-4.5 text-[#0369A1] group-hover:text-white transition-colors duration-300" strokeWidth={2} />
                  </div>
                  <span className="text-2xl font-extrabold text-[#E2E8F0] group-hover:text-[#0369A1]/15 transition-colors">
                    {r.accent}
                  </span>
                </div>
                <h3 className="text-base font-bold text-[#0F172A] mb-2">{r.title}</h3>
        ...
        <div className="text-center mt-14">
          <a
            href="#contact"
            className="inline-flex items-center gap-2 rounded-lg bg-[#0369A1] px-7 py-3.5 text-sm font-semibold text-white transition-all hover:bg-[#0F172A]"
          >
