        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  {stats.map((s) => {
                    ...
                    return (
                      <div key={s.label} className="text-center">
                        <Icon className="mx-auto mb-1.5 h-4 w-4 text-[#2A2A2E]" />
                        <p className="text-xl font-extrabold text-[#2A2A2E]">{s.value}</p>
          ...
          <ScrollReveal delay={200}>
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#2A2A2E] leading-tight mb-8">
                Un artisan passionné, proche de vous.
              </h2>

              <div className="space-y-5 text-[#666] text-base leading-relaxed">
                <p>
                  Derrière <strong className="text-[#2A2A2E]">OC CLIM</strong>, il y a une conviction :
                  chacun mérite un air sain et un confort thermique optimal chez soi.
                </p>
                <p>
                  <strong className="text-[#2A2A2E]">Can Oruc</strong>, fondateur et gérant, est technicien
                  diplômé d'un Bac Pro TFCA. Il intervient sur toute la <strong className="text-[#2A2A2E]">métropole bordelaise</strong> et ses alentours avec réactivité et professionnalisme.
                </p>
                <p>
                  ...
                  return (
                    <div key={c.text} className="flex items-center gap-3">
                      <div className="h-9 w-9 rounded-lg bg-[#F0F0F0] flex items-center justify-center shrink-0">
                        <Icon className="h-4 w-4 text-[#2A2A2E]" />
                      </div>
