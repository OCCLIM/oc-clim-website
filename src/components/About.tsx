      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="mt-8 space-y-5 text-[#777777] text-lg leading-relaxed">
              <p>
                Derrière <strong className="text-[#111111]">OC CLIM</strong>, il y a
                une conviction : chacun mérite un air sain et un confort thermique
                optimal chez soi.
              </p>
              <p>
                <strong className="text-[#111111]">Can Oruc</strong>, fondateur et gérant,
                est technicien diplômé d'un Bac Pro TFCA. Basé à
                <strong className="text-[#111111]"> Cestas (33610)</strong>, il intervient
            ...
            <div className="mt-12 space-y-6 relative">
              ...
              {timeline.map((m, i) => (
                <div key={i} className="relative pl-10">
                  <div className="absolute left-0 top-1 h-6 w-6 rounded-full bg-[#111111]/10 flex items-center justify-center">
                    <div className="h-2.5 w-2.5 rounded-full bg-[#111111]" />
                  </div>
                  <p className="text-xs font-bold uppercase tracking-wider text-[#111111]">{m.year}</p>
                  <p className="text-[#444444] font-medium mt-0.5">{m.text}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl bg-[#111111] p-8 text-white">
              <div className="flex items-center gap-4 mb-6">
                <div className="h-16 w-16 rounded-xl bg-[#111111] flex items-center justify-center">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-3">
                  <GraduationCap className="h-4 w-4 text-[#444444] shrink-0" />
                  <span className="text-slate-300">Bac Pro TFCA</span>
                </div>
                <div className="flex items-center gap-3">
                  <MapPin className="h-4 w-4 text-[#444444] shrink-0" />
                  <span className="text-slate-300">Cestas (33610) — Bordeaux Métropole</span>
                </div>
                <div className="flex items-center gap-3">
                  <Shield className="h-4 w-4 text-[#444444] shrink-0" />
                  <span className="text-slate-300">Garantie décennale</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="h-4 w-4 text-[#444444] shrink-0" />
            ...
            <div className="grid grid-cols-3 gap-4">
              {stats.map((s) => {
                const Icon = s.icon;
                return (
                  <div key={s.label} className="bg-[#FAFAFA] rounded-xl p-5 text-center border border-[#E5E5E5]">
                    <Icon className="mx-auto mb-2 h-5 w-5 text-[#111111]" />
            ...
            {/* Brands */}
            <div className="rounded-xl border border-[#E5E5E5] p-5 bg-[#FAFAFA]">
              ...
              <div className="flex flex-wrap gap-2">
                {["Daikin", "Mitsubishi", "Heiwa", "Ariston", "Atlantic"].map((b) => (
                  <span key={b} className="px-3 py-1 rounded-md bg-white text-xs font-medium text-[#444444] border border-[#E5E5E5]">
                    {b}
                  </span>
                ))}
              </div>
