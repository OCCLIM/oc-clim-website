...
export default function Contact() {
  ...
  const inputClass =
    "w-full rounded-lg border border-[#E5E5E5] bg-white px-4 py-3.5 text-sm text-[#1C1C1E] placeholder:text-[#BBB] focus:outline-none focus:ring-2 focus:ring-[#111]/10 focus:border-[#1C1C1E] transition";
            ...
            <div className="bg-[#FAFAFA] rounded-2xl p-8 lg:p-10 border border-[#E5E5E5]">
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-16 animate-fade-in">
                  ...
                  <h3 className="text-xl font-bold text-[#1C1C1E]">Demande envoyée !</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 bg-[#1C1C1E] text-white font-bold py-4 rounded-lg text-sm uppercase tracking-wide hover:bg-[#3C3C3E] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
