...
export default function Contact() {
  ...
  const inputClass =
    "w-full rounded-lg border border-[#E5E5E5] bg-white px-4 py-3.5 text-sm text-[#111] placeholder:text-[#BBB] focus:outline-none focus:ring-2 focus:ring-[#111]/10 focus:border-[#111] transition";
            ...
            <div className="bg-[#FAFAFA] rounded-2xl p-8 lg:p-10 border border-[#E5E5E5]">
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-16 animate-fade-in">
                  ...
                  <h3 className="text-xl font-bold text-[#111]">Demande envoyée !</h3>
