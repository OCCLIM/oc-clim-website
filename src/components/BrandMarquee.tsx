          ...
          <div className="flex animate-marquee-fast hover:[animation-play-state:paused]">
            {items.map((brand, i) => (
              <button
                ...
                className="flex-shrink-0 mx-8 text-sm font-bold tracking-[0.15em] text-[#ccc] hover:text-[#2A2A2E] transition-colors duration-300 cursor-pointer select-none"
              >
                {brand.name}
              </button>
            ))}
            ...
            <div className="px-8 py-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="font-semibold text-[#2A2A2E]">{selected.founded}</span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <Award className="h-4 w-4 text-[#999] shrink-0" />
                  <span className="text-[#777]">Spécialité</span>
                  <span className="font-semibold text-[#2A2A2E]">{selected.specialty}</span>
                </div>
              </div>
              ...
              <div className="mt-6 pt-5 border-t border-[#eee] flex items-center justify-between">
                ...
                <a
                  href="#contact"
                  onClick={() => setSelected(null)}
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-[#2A2A2E] hover:text-[#555] transition-colors"
                >
                  Demander un devis
