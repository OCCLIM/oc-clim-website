          ...
          <div className="flex items-end justify-between gap-12">
            ...
            <div className="max-w-3xl">
              ...
              <div className="mt-6 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 animate-fade-in-up delay-400">
                <a
                  href="tel:0767117530"
                  className="inline-flex items-center justify-center gap-2.5 bg-white text-[#1C1C1E] px-6 py-3.5 sm:px-7 sm:py-4 rounded-xl text-sm font-bold tracking-wide uppercase hover:bg-white/90 transition-all"
                >
