      ...
      <div className="py-24 sm:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1C1C1E] leading-tight max-w-3xl">
            ...
            {solutions.map((s, i) => {
              ...
              return (
                <ScrollReveal key={s.title} delay={i * 80}>
                  <div className="group text-center p-6 rounded-2xl border border-[#E5E5E5] bg-white hover:border-[#1C1C1E]/15 hover:shadow-lg transition-all duration-300 cursor-pointer">
                    <div className="mx-auto h-10 w-10 rounded-xl bg-[#F0F0F0] flex items-center justify-center mb-3 group-hover:bg-[#1C1C1E] transition-colors duration-300">
                      <Icon className="h-5 w-5 text-[#1C1C1E] group-hover:text-white transition-colors duration-300" strokeWidth={1.8} />
                    </div>
                    <h3 className="text-sm font-bold text-[#1C1C1E] mb-1">{s.title}</h3>
