...
export default function Testimonials() {
  return (
    <section id="avis" className="py-24 sm:py-32 bg-[#111111]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-14">
          <p className="text-sm font-semibold uppercase tracking-wider text-[#444444] mb-3">
            Témoignages
          </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {testimonials.map((t) => (
            ...
            >
              <Quote className="h-6 w-6 text-[#111111]/30 mb-4" />
              <p className="text-slate-300 leading-relaxed text-[15px] mb-6">
                « {t.text} »
              </p>
              <div className="flex items-center gap-3 pt-4 border-t border-white/[0.06]">
                <div className="h-9 w-9 rounded-lg bg-[#111111]/20 flex items-center justify-center">
                  <span className="text-xs font-bold text-[#444444]">{t.initials}</span>
                </div>
                <div>
        ...
        <div className="text-center mt-10">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm text-slate-400 hover:text-[#444444] transition-colors"
          >
