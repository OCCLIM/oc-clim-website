...
export default function Footer() {
  return (
    <footer className="bg-[#111111] text-slate-400">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-base font-bold text-white">
                OC <span className="text-[#444444]">CLIM</span>
              </span>
            </div>
            ...
            <p className="text-sm">
              <a href="https://occlim.fr" className="text-[#444444] hover:underline">occlim.fr</a>
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Climatisation", "Pompe à chaleur", "Entretien", "Dépannage"].map((s) => (
                <li key={s}>
                  <a href="#services" className="text-sm hover:text-[#444444] transition-colors">{s}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.label}>
                  <a href={link.href} className="text-sm hover:text-[#444444] transition-colors">{link.label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:0767117530" className="hover:text-[#444444] transition-colors">07 67 11 75 30</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 shrink-0 text-[#444444]" />
                <a href="mailto:occlim@outlook.com" className="hover:text-[#444444] transition-colors">occlim@outlook.com</a>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="h-4 w-4 mt-0.5 shrink-0 text-[#444444]" />
                <span>2B Chemin du Chibaley<br />33610 Cestas</span>
              </li>
              <li className="flex items-center gap-2">
                <Clock className="h-4 w-4 shrink-0 text-[#444444]" />
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-1 text-xs text-slate-500 hover:text-[#444444] transition-colors">
