      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              <ScrollReveal key={i} delay={i * 60}>
                <div className={`bg-white rounded-xl border transition-all duration-300 ${
                  isOpen ? "border-[#111]/15 shadow-md" : "border-[#E5E5E5] hover:border-[#111]/10"
                }`}>
                  <button
        ...
        <ScrollReveal delay={500}>
          <div className="mt-12 text-center">
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-[#111] text-white font-semibold px-6 py-3 rounded-xl text-sm hover:bg-[#333] transition-colors"
            >
              Contactez-nous
            </a>
          </div>
