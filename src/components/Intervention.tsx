      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="group text-center">
                  ...
                  <div className="relative h-56 rounded-2xl overflow-hidden mb-6">
                    ...
                    <div className="absolute top-4 left-4 h-10 w-10 rounded-full bg-white flex items-center justify-center shadow-lg">
                      <span className="text-sm font-extrabold text-[#111]">0{i + 1}</span>
                    </div>
                  </div>

                  {/* Icon */}
                  <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#111] mb-4">
        ...
        <ScrollReveal delay={500}>
          <div className="text-center mt-16">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-[#111] text-white px-8 py-4 rounded-lg text-sm font-bold uppercase tracking-wide hover:bg-[#333] transition-colors"
            >
